...
export const ExchangeClosing: React.FC<Props> = ({ handleIncrement }) => {
  ...
  function handleOpenExchangeContractModal() {
    setIsExchangeContractModalOpen(true);
  }

  function handleOpenIncompleteDataModalOpen() {
          ...
          <FormFormik ref={formRef}>
            <FormShell clickFunction={() => 0}>
              ...
              <NewTransactionModal
                ...
                buttonBackgroundColor="#3751FE"
                buttonBackgroundColorTwo="#F4F7FE"
                clickFunction={handleCloseIncompleteDataModalOpen}
                inputState={false}
                descriptionState={true}
                buttonTwoState={true}
                imageState={true}
